 ...
 */
/*
#define kAPP_ID     @"173019"
#define kAPI_Key    @"77d66d3480634e69a6464b275d2e3899"
*/
...
@class ROPublishFeedRequestParam;
@class ROPasswordFlowRequestParam;
@class RenrenPay;

@interface Renren: NSObject <RORequestDelegate> {
...
-(void)publishFeed:(ROPublishFeedRequestParam *)param andDelegate:(id<RenrenDelegate>)delegate;
/**
 * 获取好友id列表
