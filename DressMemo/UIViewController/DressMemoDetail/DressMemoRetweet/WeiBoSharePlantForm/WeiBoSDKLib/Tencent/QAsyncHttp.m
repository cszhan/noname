...
- (NSURLConnection *)httpPostWithFileData:(NSData *)fileData url:(NSString *)aUrl queryString:(NSString *)aQueryString delegate:(id)aDelegare {
	
	NSMutableURLRequest *request = [QMutableURLRequest requestPostWithFileData:fileData url:aUrl queryString:aQueryString];
	return [NSURLConnection connectionWithRequest:request delegate:aDelegare];
}
